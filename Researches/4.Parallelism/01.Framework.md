...
* #### 요소 기술 1: Multi-Generational Heap Layout
	![Fig5](/images/04/04-01-05.png){:width="65%"}
...
* #### 요소 기술 2: 객체 단위 프로파일링 도구
	![Fig6](/images/04/04-01-06.png){:width="65%"}
	...
	![Fig7](/images/04/04-01-07.png){:width="65%"}
...
* #### Near-far 메모리 환경 에뮬레이션
	...
	![Fig8](/images/04/04-01-08.png){:width="65%"}
...
* #### 평가
	...
	![Fig9](/images/04/04-01-09.png){:width="65%"}
	...
	![Fig10](/images/04/04-01-10.png){:width="65%"}
	...
	![Fig11](/images/04/04-01-11.png){:width="65%"}
...
![Fig12](/images/04/04-01-12.png){:width="65%"}
...
![Fig13](/images/04/04-01-13.png){:width="55%"}
...
![Fig14](/images/04/04-01-14.png){:width="65%"}
...
* #### Intel Knights Landing
	![Fig15](/images/04/04-01-15.png){:width="65%"}
	...
	![Fig16](/images/04/04-01-16.png){:width="65%"}
...
## 분석
![Fig17](/images/04/04-01-17.png){:width="65%"}
...
![Fig18](/images/04/04-01-18.png){:width="65%"}
...
## 성능 측정 결과
![Fig19](/images/04/04-01-19.png){:width="65%"}
...
![Fig20](/images/04/04-01-20.png){:width="65%"}
...
* 코어 개수 별 성능 확장성
	...
	![Fig21](/images/04/04-01-21.png){:width="65%"}
	...
	![Fig22](/images/04/04-01-22.png){:width="65%"}
...
* 배치 크기 별 성능 확장성
	...
	![Fig23](/images/04/04-01-23.png){:width="65%"}
...
* 계층 단위 실행 시간
	...
	![Fig24](/images/04/04-01-24.png){:width="65%"}
...
* 논문
  - [JAWS: A JavaScript Framework for Adaptive CPU-GPU Work Sharing](/paper/04/04-01-JAWS A JavaScript Framework for Adaptive CPU-GPU Work Sharing.pdf)
  - [QoS-aware Dynamic Power Optimization for Data Parallel JavaScript Programs](/paper/04/04-01-QoS-aware Dynamic Power Optimization for Data Parallel JavaScript Programs.pdf)
  - [Workload-Aware Optimal Power Allocation on Single-Chip Heterogeneous Processors](/paper/04/04-01-Workload-Aware Optimal Power Allocation on Single-Chip Heterogeneous Processors.pdf)
* [WASP 시연 영상](http://manycoreos.synology.me/mediawiki/images/6/6f/2017_WASP_%EC%8B%9C%EC%97%B0_%EC%98%81%EC%83%81.mp4)
  - Youtube : <https://youtu.be/p8AoCytMWx8>
